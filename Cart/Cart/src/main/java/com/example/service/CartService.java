...
//    private static final String USER_SERVICE_URL = "http://localhost:8084/users";  // User MS
    ...
    private static final String BOOK_SERVICE_URL = "http://localhost:9090/books"; // Book Service via API Gateway
    private static final String USER_SERVICE_URL = "http://localhost:9090/users"; // User Service via API Gateway
